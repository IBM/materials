...
def get_parser(parser=None):
   ...
   # resume_arg = parser.add_argument_group('Resume')
    ...
    parser.add_argument('--model_path', type=str, default='./GMsT/')
    parser.add_argument('--ckpt_filename', type=str, default='GMsT-Light_40.pt')
    #parser.add_argument('--n_output', type=int, default=1)
    parser.add_argument('--save_ckpt', type=int, default=1)
    parser.add_argument('--start_seed', type=int, default=0)
    parser.add_argument('--GMsT_version', type=str, default='v1')

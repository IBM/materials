...
result = fm4m.single_modal(model=model_type, task_name= "bace", x_train=xtrain, y_train=ytrain, x_test=xtest, y_test=ytest, downstream_model="XGBClassifier", save_model=True)

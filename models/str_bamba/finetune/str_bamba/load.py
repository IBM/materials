...
def load_strbamba(ckpt_filename,
	...
	# load model
	model = BambaEncoderDecoder(bamba_config, tokenizer, n_output=n_output, dropout=dropout, device=device, dtype=dtype)
	...
	model.load_state_dict(ckpt_dict['module'], strict=False)

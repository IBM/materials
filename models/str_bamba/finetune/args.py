...
def get_parser(parser=None):
    ...
    parser.add_argument(
        "--lr_encoder", type=float, default=3 * 1e-4, help="Initial lr value"
    )
    parser.add_argument(
        "--lr_predictor", type=float, default=3 * 1e-4, help="Initial lr value"
    )
    parser.add_argument(
    ...
    parser.add_argument("--tokenizer_filename", type=str, default="smi_ted_Light_40.pt")
    parser.add_argument("--model_config_filename", type=str, default="smi_ted_Light_40.pt")
    ...
    parser.add_argument('--inputs', metavar='N', type=str, nargs='+', help='an integer for the accumulator')

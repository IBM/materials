python -u ../../finetune_regression.py \
    ...
    --data_root '../../../data/datasets/polymer/Polymer-Electron-Affinity-(Eea)' \
    --dataset_name Polymer-Electron-Affinity-Eea \
    --measure_name 'Eea' \
    --inputs 'POLYMER SMILES' \
    --checkpoints_folder './checkpoints_polymer-electron-affinity-eea' \
    --loss_fn 'rmse' \
    --target_metric 'rmse' \
    --save_ckpt 1 \
    --start_seed 0 \

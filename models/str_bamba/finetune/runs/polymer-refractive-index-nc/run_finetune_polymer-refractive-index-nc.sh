python -u ../../finetune_regression.py \
    ...
    --data_root '../../../data/datasets/polymer/Polymer-Refractive-Index-(Nc)' \
    --dataset_name Polymer-Refractive-Index-Nc \
    --measure_name 'Nc' \
    --inputs 'POLYMER SMILES' \
    --checkpoints_folder './checkpoints_polymer-refractive-index-nc' \
    --loss_fn 'rmse' \
    --target_metric 'rmse' \
    --save_ckpt 1 \
    --start_seed 0 \

...
from .modules import ImageEncoder, TextEncoder, ProjectionHead, Net
...
class CLIPModel(nn.Module):
    def __init__(self, device='cpu', config=None, temperature=1.0):
        ...
        if config:
            ...
            self.net = Net(smiles_embed_dim=1024, n_output=1, dropout=0.1)
    ...
    def load_checkpoint(self, ckpt_path):
        ...
        # force image and text encoder's training
        self.config_model.trainable = True
        ...
        # restore weights
        self.load_state_dict(ckpt_dict['MODEL_STATE'], strict=False)

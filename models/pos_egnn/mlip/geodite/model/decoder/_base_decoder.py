...
class AbstractDecoder(nn.Module):
    ...
    def task(self):
        DECODER_TO_TASK = {
            "BandGapDecoder": "Band Gap",
            "BinaryClassificationDecoder": "Binary Classification",
            "ScalarRegressionDecoder": "Scalar Regression",
            "AtomicContributionDecoder": "Atomic Contribution",
            "PartialChargeDecoder": "Partial Charge",
            "QM9Decoder": "QM9",
